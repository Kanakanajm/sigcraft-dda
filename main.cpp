...
int main(int argc, char **argv) {
    ...
    push_constants_vert.vertex_buffer = vertex_buffer->device_address();
                ...
                context.frame().withRenderTargets(
                    cmdbuf, {&image}, &*depthBuffer, [&]() {
                        ...
                        */
                        ...
                        push_constants_vert.matrix = m;
                        for (ivec2 loca : chunk_locas) {
                            mat4 cube_matrix = m;
                            push_constants_vert.chunk_position = {loca[0], 0,
                                                                  loca[1]};

                            vkCmdPushConstants(cmdbuf, pipeline->layout(),
                                               VK_SHADER_STAGE_VERTEX_BIT, 0,
                                               sizeof(push_constants_vert),
                                               &push_constants_vert);
